...
/*   Updated: 2019/07/17 15:58:04 by akharrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed		Fixed::operator + ( const Fixed & rhs ) {
	return (
		Fixed(
			(float) (( _fixed_pt_value + rhs._fixed_pt_value ) / (double) ( 1 << _fractional_bits ))
		)
	);
}
	...
	return (
		Fixed(
			(float) (
				( _fixed_pt_value * rhs._fixed_pt_value )
									/
				( (double) ( 1 << _fractional_bits ) * (double) ( 1 << _fractional_bits ) )
			)
		)
	);
}
...
Fixed		Fixed::operator / ( const Fixed & rhs ) {
	return (
		Fixed(
			(float) ( (double) _fixed_pt_value / (double) rhs._fixed_pt_value )
		)
	);
}
